...
Wherever a command takes `<artifact>`, `<run>` or `--run`, it takes the link as readily as the slug: paste `https://krowk.com/a/art_…`, the CDN URL under it, or anything else krowk printed, and the slug is read out of it.
